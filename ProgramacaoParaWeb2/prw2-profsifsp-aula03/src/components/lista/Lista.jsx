...
const Lista = (props) => {
    ...
    <div className="lista">
        ...
        { 
        //não usaremos este componente no projeto, mas estamos usando para testar listas.
        ...
        // O resultado deste map é um array de elementos JSX, que o React renderiza como uma lista de professores na interface do usuário.
        }
        {props.objetos.map( (objeto, index) => (
            ...
            // Isso ajuda o React a identificar quais itens mudaram, foram adicionados ou removidos.
            <div key={index}>
